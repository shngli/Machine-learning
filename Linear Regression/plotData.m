...
% "plot" commands. Set the axes labels using the "xlabel" and "ylabel" 
% commands. Assume the population and revenue data have been passed in
...
figure;
% Plot the data, 10 = size of the X marker
